...
android.permissions = INTERNET,ACCESS_FINE_LOCATION,ACCESS_COARSE_LOCATION,WRITE_EXTERNAL_STORAGE,READ_EXTERNAL_STORAGE,READ_MEDIA_IMAGES,CAMERA

# (int) Target Android API - Android 14 (API 34) for Play Store compliance
android.api = 34
...
# (str) Path to the Android NDK (will use system NDK in CI)
# android.ndk_path =
